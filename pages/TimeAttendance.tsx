                            ...
                            <div className="flex flex-col items-start gap-3">
                                ...
                                <div className="flex flex-col leading-tight">
                                    <div className="flex items-center gap-2">
                                        <h1 className={`text-lg font-bold leading-none truncate max-w-[150px] ${theme.textPrimary}`}>
                                    ...
                                    <p className={`text-[11px] font-black uppercase tracking-tight mt-1 opacity-80 ${theme.textSecondary}`}>
