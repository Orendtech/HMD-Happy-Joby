                                        ...
                                        <div className="flex justify-between items-center bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 p-4 rounded-2xl shadow-sm hover:border-cyan-500/30 transition-all">
                                            <div className="flex-1 min-w-0 pr-4">
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    ...
                                                    {hasInteractions && (
                                                        <span className="px-1.5 py-0.5 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 text-[8px] font-black rounded-full uppercase border border-emerald-200 dark:border-emerald-500/20 flex items-center gap-1">
                                                            <Check size={8}/> {draft.interactions.length} Note
                                                        </span>
                                                    )}
                                                </div>
                                            </div>
