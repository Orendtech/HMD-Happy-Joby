...
const TimeAttendance: React.FC<Props> = ({ user, userProfile: initialProfile }) => {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto space-y-6">
            ...
            <div className="sticky top-2 z-30 pt-0 pb-2 bg-[#F5F5F7]/80 dark:bg-[#020617]/80 backdrop-blur-xl border-b border-transparent transition-all rounded-[32px] px-0.5">
                <div className="flex items-stretch gap-2">
                    ...
                    <button onClick={() => setShowQuestPage(true)} className="w-16 flex flex-col items-center justify-center bg-slate-200 dark:bg-slate-800 rounded-[28px] shadow-lg active:scale-95 transition-all group relative border-2 border-white/30 overflow-hidden shrink-0">
            ...
            <div className="space-y-6 pt-2">
                ...
                <div className="relative rounded-[32px] border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 shadow-xl overflow-visible" ref={dropdownRef}>
                    <div className="h-56 w-full relative overflow-hidden rounded-t-[32px]">
                        ...
                        <button onClick={getLocation} className="absolute top-3 right-3 bg-white/90 dark:bg-slate-900/80 backdrop-blur-md p-2.5 rounded-full text-slate-600 dark:text-white shadow-xl border border-slate-200 dark:border-white/10 z-20 hover:bg-white dark:hover:bg-slate-800 transition-all active:scale-90"><Navigation size={18} /></button>
